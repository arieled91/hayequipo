...
create table game.game_players (game_id int8 not null, player_id int8 not null, primary key (game_id, player_id));
...
alter table auth.users_roles add constraint FKgd3iendaoyh04b95ykqise6qh foreign key (user_id) references auth."user";
...
alter table game.game_players add constraint FKlmowt97iqduhb6ds0jgjpo4uu foreign key (player_id) references game.player;
alter table game.game_players add constraint FKfjnwm25clh3tf6qwuohsmdtkj foreign key (game_id) references game.game;;;
